...
public class VoteMachine implements Xlet, HActionListener,
    ...
    public void initXlet(XletContext context) throws XletStateChangeException {
      ...
      imager = new InterfaceDrawer();
        ...
        confirm=new HTextButton("confirm",      260, 500, 120, 50);
        
        goback=new HTextButton("cancel",        380, 500, 120, 50);
    ...
    public void showNominees(){
        ...
        scene.add(help);    scene.add(imager);
